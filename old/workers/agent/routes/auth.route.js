 ...
 * @param id
 */
const meta = function(id) { return require('../../../common/helpers/route.helper').getRouteMeta(id, worker) };
...
module.exports = function (app) {
    ...
    // router[meta('LOGIN').method](endpoint('LOGIN'), meta('LOGIN').controllerFunction);
